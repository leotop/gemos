<?
    ...
    $arIBlockSection=CIBlockSection::GetList(
        array(),
        array('ID'=>$arResult['ID'], 'IBLOCK_ID'=>12),
        false,
        array("UF_*")
    );
    while($ar = $arIBlockSection->Fetch())
    {                          
        $arResult["SECTION"]=$ar;
    }
    $img=CFile::ResizeImageGet($arResult['PICTURE']['ID'], 
