<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();
    ...
    $this->setFrameMode(true);
     //задание текста под заголовком страницы
    $APPLICATION->SetPageProperty("redback_text",
       "Аппараты для плазмафереза, гемосорбции и других методов детоксикации (очищения крови) в комплекте с расходными материалами.");
