...
<div class="wrappInfo" <?if(empty($arResult['SEARCH'])) echo 'id="search-empty"';?> >
    ...
    <?if($arParams["USE_SUGGEST"] === "Y"):
        ...
        <?endif;?>
    &nbsp;
    <input class="search_submit" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>" />
    <noindex>
    ...
    <div id="section_wrap_1_detail">
        <?foreach($arResult["SEARCH"] as $arItem):?>
            <div class="text_block_quality">
                <a href="<?=$arItem["URL"]?>">
                    <p class="titles"><?=$arItem["TITLE_FORMATED"]?></p>
                </a>
                <p class="text"><?=$arItem["BODY_FORMATED"]?></p>
            </div>
            <?endforeach;?>
    </div>
    <?endif;?>
